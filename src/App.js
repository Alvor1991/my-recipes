...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .detail-section-title {
    ...
    margin-bottom: 20px;
    padding-bottom: 10px;
    border-bottom: 2px solid #b5813a;
  }
  ...
  .form-group select:focus { border-color: #b5813a; }
  ...
  .btn-primary {
    flex: 1; background: #1a1208; color: #faf8f4;
  ...
  .btn-cancel {
    background: none; border: 1.5px solid #d4c9b0; color: #7a6a50;
  ...
  .empty {
    ...
    font-family: 'Playfair Display', serif;
    font-size: 20px; color: #b5a88a; font-style: italic;
  }
`;
...
export default function App() {
  ...
  const [form, setForm] = useState({ title: "", category: "Italian", time: "", serves: "", description: "", ingredients: "", steps: "", image: null });
  ...
  const handleSubmit = () => {
    ...
    setForm({ title: "", category: "Italian", time: "", serves: "", description: "", ingredients: "", steps: "", image: null });
    setShowForm(false);
  };
